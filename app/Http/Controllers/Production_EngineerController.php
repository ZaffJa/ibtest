...
use App\Production;
use App\Deparment;
class Production_EngineerController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('production-engineer.index', ['productions' => $productions])->withDeparments($deparments);
    }
    ...
    {
        //
        return view('production-engineer.index');
    }
