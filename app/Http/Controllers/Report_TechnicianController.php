...
class Report_TechnicianController extends Controller
{
    /**
    ...
    public function index()
    {
      ...
      return view('report-technician.index')->withReports($reports)->withProductions($productions);
    }
    ...
    {
      $productions = Production::all();
      return view('report-technician.create')->withProductions($productions);
    }
    ...
    public function store(Request $request)
    {
      ...
      return redirect()->route('report-technician.create')->with('alert-success', 'Data has been saved!');
    }
    ...
    public function editNameTech(Request $request)
    {
