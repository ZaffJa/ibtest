          ...
          <div class="col-md-8 col-md-offset-2">
              <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                      <form class="form-horizontal" role="form" method="POST" action="{{ route('report-engineer.store') }}">
                          {{ csrf_field() }}
                          ...
                          <div class="form-group">
                              <div class="col-md-6 col-md-offset-4">
                                  ...
                                  <a href="{{ route('report-engineer.index') }}" class="btn btn-warning">View Report</a>
                              </div>
                          </div>
