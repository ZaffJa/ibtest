          ...
          <div class="col-md-8 col-md-offset-2">
              <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                      <form class="form-horizontal" role="form" method="POST" action="{{ route('supplier.update', $supplier->id) }}">
                          ...
                          <div class="form-group{{ $errors->has('comp_name') ? ' has-error' : '' }}">
                              ...
                              <div class="col-md-6">
                                  <input id="comp_name" type="text" class="form-control" name="comp_name" value="{{ $supplier->comp_name }}" >
                          ...
                          <div class="form-group{{ $errors->has('tel_no') ? ' has-error' : '' }}">
                              ...
                              <div class="col-md-6">
                                  <input id="tel_no" type="text" class="form-control" name="tel_no" value="{{ $supplier->tel_no }}" >
                          ...
                          <div class="form-group{{ $errors->has('office_no') ? ' has-error' : '' }}">
                              ...
                              <div class="col-md-6">
                                  <input id="office_no" type="text" class="form-control" name="office_no" value="{{ $supplier->office_no }}" >
                           ...
                           <div class="form-group{{ $errors->has('pic') ? ' has-error' : '' }}">
                               ...
                               <div class="col-md-6">
                                   <input id="pic" type="text" class="form-control" name="pic" value="{{ $supplier->pic }}" >
